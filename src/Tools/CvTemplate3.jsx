        ...
        <div className="cv-container">
            ...
            <div ref={cvRef}>
                <div className="flex max-w-4xl mx-auto bg-white" style={{ width: '220mm', minHeight: minHeight }}>
                    <div className="w-1/3 p-5 text-white bg-indigo-700">
                        ...
                        <div className="mt-6">
                            <h3 className="pb-1 mb-3 border-b border-gray-700">Contact</h3>
                    ...
                    <div className="w-2/3 p-5">
                        <div className="text-start">
                            <h1 className="text-3xl font-bold text-indigo-700">{formData.name}</h1>
