...
const TopNav = () => {
  ...
  return (
    ...
    >
      ...
      <motion.ul
        className={`md:flex md:items-center md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-10 transition-all duration-500 ease-in-out ${isOpen ? 'top-16 opacity-100 visible' : 'top-full opacity-0 invisible'}`}
