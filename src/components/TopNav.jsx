...
const TopNav = () => {
  ...
  return (
    <nav className="relative sticky top-0 z-10 p-5 bg-white shadow md:flex md:items-center md:justify-between">
      ...
      <ul className={`md:flex md:items-center md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-10 md:opacity-100 transition-all duration-300 ${isOpen ? 'top-20 opacity-100' : 'top-full opacity-0'} justify-center`}>
